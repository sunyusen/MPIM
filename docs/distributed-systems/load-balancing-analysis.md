...
upstream im_gateway {
    ...
    server 127.0.0.1:6001 weight=2 max_fails=3 fail_timeout=30s;
...
graph TB
    subgraph "MPIM网关层负载均衡"
        ...
        subgraph "网关服务集群"
            G1[im-gateway-1<br/>127.0.0.1:6000]
            G2[im-gateway-2<br/>127.0.0.1:6001]
            G3[im-gateway-3<br/>127.0.0.1:6002]
        end
