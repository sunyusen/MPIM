								  ...
								  google::protobuf::Closure *done)
{
	...
	snprintf(sql, sizeof(sql), 
		"INSERT INTO groups(group_name, description, creator_id, created_at) VALUES('%s', '%s', %lld, %lld)",
		req->group_name().c_str(), req->description().c_str(), req->creator_id(), now);
	...
	snprintf(sql2, sizeof(sql2), 
		"INSERT INTO group_members(group_id, user_id, joined_at) VALUES(%lld, %lld, %lld)",
		group_id, req->creator_id(), now);
								 ...
								 google::protobuf::Closure *done)
{
	...
	char sql[512];
	snprintf(sql, sizeof(sql), 
		"DELETE FROM group_members WHERE group_id=%lld AND user_id=%lld",
									  ...
									  google::protobuf::Closure *done)
{
	...
	char sql[512];
	snprintf(sql, sizeof(sql), 
		"SELECT user_id FROM group_members WHERE group_id=%lld", req->group_id());
									...
									google::protobuf::Closure *done)
{
	...
	char sql[512];
	snprintf(sql, sizeof(sql), 
		"SELECT group_id FROM group_members WHERE user_id=%lld", req->user_id());
...
bool GroupServiceImpl::groupExists(int64_t group_id)
{
	char sql[512];
	snprintf(sql, sizeof(sql), 
		"SELECT 1 FROM groups WHERE group_id=%lld LIMIT 1", group_id);
