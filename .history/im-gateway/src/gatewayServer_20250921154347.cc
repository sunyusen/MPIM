...
// ---------- ctor ----------
// 初始化网关服务器的核心组件：网络服务、RPC通道、服务代理、redis消息队列订阅
	...
	: server_(loop, addr, "im-gateway"), gateway_id_(gateway_id)
{
	...
	{
		LOG_ERROR << "redis message queue connect failed, Deliver will not push online messages";
	}
