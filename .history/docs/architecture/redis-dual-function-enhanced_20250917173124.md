...
graph TB
    subgraph "🔧 业务服务层"
        direction TB
        subgraph "微服务集群"
            USER[👤 用户服务<br/>im-user:6000<br/>• 用户管理<br/>• 好友关系<br/>• 认证授权]
            PRES[📍 在线状态服务<br/>im-presence:6000<br/>• 路由管理<br/>• 状态维护<br/>• 连接映射]
            MSG[💬 消息服务<br/>im-message:6000<br/>• 消息存储<br/>• 消息转发<br/>• 离线处理]
            GROUP[👥 群组服务<br/>im-group:6000<br/>• 群组管理<br/>• 成员管理<br/>• 权限控制]
        end
    end
    ...
    subgraph "🚪 网关服务层"
        direction TB
        subgraph "网关集群"
            G1[🚪 网关服务-1<br/>gateway-001:6000<br/>• 连接管理<br/>• 协议解析<br/>• 消息路由]
            G2[🚪 网关服务-2<br/>gateway-002:6000<br/>• 连接管理<br/>• 协议解析<br/>• 消息路由]
            G3[🚪 网关服务-N<br/>gateway-N:6000<br/>• 连接管理<br/>• 协议解析<br/>• 消息路由]
        end
    end
