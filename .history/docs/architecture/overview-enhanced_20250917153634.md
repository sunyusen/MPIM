...
graph TB
    ...
    subgraph "🚪 接入层 (Gateway Layer)"
        direction TB
        subgraph "网关服务集群"
            G1[🚪 网关服务-1<br/>gateway-001:8000<br/>• Muduo网络库<br/>• 连接池管理<br/>• 协议解析<br/>• 用户认证<br/>• 会话管理]
            G2[🚪 网关服务-2<br/>gateway-002:8000<br/>• Muduo网络库<br/>• 连接池管理<br/>• 协议解析<br/>• 用户认证<br/>• 会话管理]
            G3[🚪 网关服务-N<br/>gateway-N:8000<br/>• Muduo网络库<br/>• 连接池管理<br/>• 协议解析<br/>• 用户认证<br/>• 会话管理]
        end
    end
    ...
    subgraph "🔧 服务层 (Service Layer)"
        direction TB
        subgraph "微服务集群"
            U[👤 用户服务<br/>im-user:8001<br/>• 用户注册/登录<br/>• 好友关系管理<br/>• 用户信息维护<br/>• 认证授权<br/>• 密码加密]
            P[📍 在线状态服务<br/>im-presence:8002<br/>• 用户路由管理<br/>• 在线状态维护<br/>• 连接映射<br/>• 状态同步<br/>• 故障检测]
            M[💬 消息服务<br/>im-message:8003<br/>• 消息存储转发<br/>• 离线消息处理<br/>• 消息持久化<br/>• 消息路由<br/>• 消息去重]
            G[👥 群组服务<br/>im-group:8004<br/>• 群聊管理<br/>• 成员管理<br/>• 权限控制<br/>• 群组信息<br/>• 群组状态]
        end
    end
...
sequenceDiagram
    ...
    ZK-->>-RPC: 5. 返回服务地址<br/>(im-user:8001)
