...
void RpcProvider::NotifyService(google::protobuf::Service *service)
{
	...
	LOG_INFO("service_name: " + service_name + " method_count: " + std::to_string(methodCnt));
...
void RpcProvider::Run()
{
	...
	LOG_INFO("ip: " + ip + " port: " + std::to_string(port));
...
void RpcProvider::SendRpcResponse(const muduo::net::TcpConnectionPtr &conn, google::protobuf::Message *response)
{
	...
	if(response && response->SerializeToString(&response_str)){
		...
		LOG_DEBUG("SendRpcResponse: Response sent successfully, size=" + std::to_string(len));
	}
	else
	{
