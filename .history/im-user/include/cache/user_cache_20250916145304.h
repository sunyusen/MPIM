...
// 用户登录信息缓存
class LoginInfoCache : public GenericCache<mpim::LoginResp> {
public:
    LoginInfoCache();
    virtual std::string Serialize(const mpim::LoginResp& value) override;
    virtual std::shared_ptr<mpim::LoginResp> Deserialize(const std::string& data) override;
};

// 好友关系缓存
class FriendsCache : public GenericCache<mpim::GetFriendsResp> {
public:
    FriendsCache();
    virtual std::string Serialize(const mpim::GetFriendsResp& value) override;
    virtual std::shared_ptr<mpim::GetFriendsResp> Deserialize(const std::string& data) override;
...
// 群组信息缓存
class GroupInfoCache : public GenericCache<mpim::GroupInfo> {
public:
    GroupInfoCache();
    virtual std::string Serialize(const mpim::GroupInfo& value) override;
    virtual std::shared_ptr<mpim::GroupInfo> Deserialize(const std::string& data) override;
};

// 群组成员缓存
class GroupMembersCache : public GenericCache<mpim::GetGroupMembersResp> {
public:
    GroupMembersCache();
    virtual std::string Serialize(const mpim::GetGroupMembersResp& value) override;
    virtual std::shared_ptr<mpim::GetGroupMembersResp> Deserialize(const std::string& data) override;
...
// 用户群组列表缓存
class UserGroupsCache : public GenericCache<mpim::GetUserGroupsResp> {
public:
    UserGroupsCache();
    virtual std::string Serialize(const mpim::GetUserGroupsResp& value) override;
    virtual std::shared_ptr<mpim::GetUserGroupsResp> Deserialize(const std::string& data) override;
};
...
private:
    LoginInfoCache login_cache_;
    FriendsCache friends_cache_;
    GroupInfoCache group_info_cache_;
    GroupMembersCache group_members_cache_;
    UserGroupsCache user_groups_cache_;
